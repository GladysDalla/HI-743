...
#Plot results
par(mfrow = c(1,2))
plot(x, col= (km.out$cluster + 1), main="K-means Clustering w. K=2", xlab="", ylab="", pch=2, cex=2)
```
...
pve = 100 * data.pca$dev^2 / sum(data.pca$dev^2)

plot(pve, type="0", ylab="PVE", xlab="Principal Component", col="blue")
